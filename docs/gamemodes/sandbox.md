# Sandbox Mode
The **Sandbox Mode** allows players to start [combats](/docs/base/combat.md) and edit any of its parts, which includes:
* [Teams](/docs/base/team.md)
* [Monsters](/docs/base/monster.md)
* Equipment
* Consumables
* Skills
