...
def test_get_least_frequent_effect_types():
    ...
    filtered = selector._get_least_frequent_effect_types(
        effects,
        k=2,
    )
...
def test_get_most_frequent_effect_types():
    selector = RandomSelector()
    effects = [
        RegenEffect(),
        StunEffect(),
    ...
    filtered = selector._get_most_frequent_effect_types(
        effects,
        k=1,
    )
