...
EFFECTS_RESOLVING = {
    ...
    "deterioration": "{source} deteriorou {value} {attribute} de {target}.",
    "deterioration_self": "{source} deteriorou {value} {attribute} de si mesmo.",
    ...
    "restoration": "{source} restaurou {value} de {attribute} de {target}.",
    "restoration_self": "{source} restaurou {value} de {attribute} de si mesmo.",
}
