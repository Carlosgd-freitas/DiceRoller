...
def previous_value(values: List[T], current_value: T) -> T:
    """
    Returns the previous element of a list of selectable items, related to the
    current selected one. The end and start of the list are wrapped around.
    ...
    :return: Previous selectable value of the list.
    :rtype: T
    """
