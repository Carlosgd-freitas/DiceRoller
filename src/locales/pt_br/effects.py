...
DESCRIPTION = {
    ...
    "fortify": "Aumenta a redução de dano de efeitos defensivos em {value}.",
    "fragile": "Reduz a redução de dano de efeitos defensivos em {value}.",
    "freeze": "Impede que o alvo aja. Remove {burn}.",
    "frostburn": "Inflige {value} de dano em todo início de turno.",
    "haste": "Aumenta a velocidade do alvo em {value}.",
    ...
    "oil": "Reduz a velocidade do alvo e aumenta o dano infligido por {burn} em {value}.",
    "pain": "Inflige {value} de dano a si mesmo. Ignora efeitos defensivos.",
    ...
    "repel": "Diminui a prioridade do alvo para os inimigos.",
    ...
    "slow": "Reduz a velocidade do alvo em {value}.",
    "strength": "Aumenta o dano infligido por efeitos ofensivos em {value}.",
    "stun": "Impede que o alvo aja.",
    "taunt": "Aumenta a prioridade do alvo para os inimigos.",
    "thorns": "Quando atacado diretamente, inflige {value} de dano ao atacante.",
    "weak": "Reduz o dano infligido por efeitos ofensivos em {value}.",
}
...
EXECUTION = {
    ...
    "pain": "{source} infligiu {value} de dano em {target} através de {keyword}.",
    "pain_self": "{source} se infligiu {value} de dano através de {keyword}.",
    "repel": "{source} fez {target} {keyword} os inimigos por {duration} turnos.",
    "repel_self": "{source} {action} os inimigos por {duration} turnos.",
...
EXECUTION_FAIL = {
    ...
    "pain": "{source} iria causar {keyword} em {target}, mas",
    "pain_self": "{source} iria sentir {keyword}, mas",
    "repel": "{source} tentou fazer {target} {keyword} os inimigos, mas",
    "repel_self": "{source} tentou {keyword} os inimigos, mas",
