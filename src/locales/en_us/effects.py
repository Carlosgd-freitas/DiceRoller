...
BLIND = {
    "name": "BLIND",
    "description": "Reduces the accuracy of target dice and skills that are not used in itself by {value_perc}%.",
    "action": None,
    "activation": None,
    "countdown": None,
    "execution": None,
...
CLEANSE = {
    ...
    "execution_self": "{source} removed {count} debuffs from itself through {keyword}",
    "execution_fail": None,
    "execution_fail_self": None,
    "fail": None,
    "removal": None,
...
CORRUPT = {
    ...
    "execution_self": "{source} removed {count} buffs from itself through {keyword}",
    "execution_fail": None,
    "execution_fail_self": None,
    "fail": None,
    "removal": None,
...
DOOM = {
    ...
    "execution_self": "{source} {action} itself. {source} will die in {duration} turns.",
    "execution_fail": "{source} tried to {keyword} {target}, but",
    "execution_fail_self": "{source} tried to {keyword} itself, but",
    "fail": None,
    "removal": None,
    "status": "DOOMED",
}
...
EXECUTE = {
    ...
    "countdown": None,
    "execution": "{source} {action} {target}.",
    "execution_self": "{source} {action} itself.",
    "execution_fail": "{source} tried to {keyword} {target}, but",
    "execution_fail_self": "{source} tried to {keyword} itself, but",
    "fail": None,
    "removal": None,
...
FOCUS = {
    "name": "FOCUS",
    "description": "Increases the accuracy of target dice and skills by {value_perc}%.",
    "action": None,
    "activation": None,
    "countdown": None,
    "execution": None,
...
FORTIFY = {
    ...
    "execution_fail_self": None,
    "fail": None,
    "removal": "{target} had its {removed_keyword} removed by the effect of {keyword}.",
    "status": "FORTIFIED",
}
...
FRAGILE = {
    ...
    "execution_fail_self": None,
    "fail": None,
    "removal": "{target} is not {removed_keyword} anymore because of {keyword}.",
    "status": "FRAGILE",
}
...
HEAL = {
    ...
    "execution_self": "{source} restored {value} {hp} of itself through {keyword}.",
    "execution_fail": None,
    "execution_fail_self": None,
    "fail": None,
    "removal": None,
...
IMMUNITY = {
    ...
    "execution_self": "{source} granted {keyword} of {count} effects to itself",
    "execution_fail": "{source} tried to turn {target} {status}, but",
    "execution_fail_self": "{source} tried to turn itself {status}, but",
    "fail": "{target} was {status}.",
    "removal": None,
    "status": "IMMUNE",
}
...
INVISIBLE = {
    ...
    "execution_self": "{source} turned itself {keyword} for {duration} turns.",
    "execution_fail": "{source} tried to turn {target} {keyword}, but",
    "execution_fail_self": "{source} tried to turn itself {keyword}, but",
    "fail": None,
    "removal": None,
    "status": None,
}
...
MANA_REGEN = {
    ...
    "action": None,
    "activation": "{target} restored {value} {mana} of itself through {keyword}.",
    "countdown": None,
    "execution": None,
    "execution_self": None,
    "execution_fail": None,
...
MANA = {
    ...
    "execution_self": "{source} restored {value} {mana} of itself through {keyword}.",
    "execution_fail": None,
    "execution_fail_self": None,
    "fail": None,
    "removal": None,
...
PAIN = {
    ...
    "execution_self": "{source} inflicted {value} damage to itself through {keyword}.",
...
REGEN = {
    ...
    "action": None,
    "activation": "{target} restored {value} {hp} of itself through {keyword}.",
    "countdown": None,
    "execution": None,
    "execution_self": None,
    "execution_fail": None,
...
REVIVE = {
    ...
    "execution_self": "{source} {action} itself and was healed by {value_perc}% of its max {hp}.",
    "execution_fail": "{source} tried to {keyword} {target}, but",
    "execution_fail_self": "{source} tried to {keyword} itself, but",
    "fail": None,
    "removal": None,
